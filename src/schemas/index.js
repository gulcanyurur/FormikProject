...
export const basicSchema = yup.object().shape({
  ...
  password: yup
    ...
    .matches(passwordRules, 'Lütfen en az 1 büyük harf, 1 küçük harf ve 1 sayı içeren bir şifre giriniz')
...
export const advancedSchema = yup.object().shape({
  username: yup
      .string()
      .min(3, 'Kullanıcı adı üç karakter olmalıdır')
      .required('Kullanıcı adı zorunludur'),

  university: yup
      .string()
      .oneOf(['bogaziçi', 'gsu', 'odtü', 'itü'], 'Lütfen üniversitenizi seçiniz')
